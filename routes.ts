...
import { DeleteUserFavoriteMediaSchema, GetMediaByIdSchema, GetMediasSchema, GetUserFavoritesListSchema, mediaIdResponseSchema, PostMediaRequestSchema, PostMediaResponseSchema, PostMediaSchema, PostSaveFavoriteSchema, PostUserFavoriteRequestSchema } from "./schemas";
...
export async function routes(app: FastifyTypeInstance) {
    ...
    app.delete('/users/:userId/favorites/:mediaId', DeleteUserFavoriteMediaSchema, async (request, reply) => {
        ...
        if (mediaIndex === -1) {
            return reply.status(404).send('Media not found')
        }
