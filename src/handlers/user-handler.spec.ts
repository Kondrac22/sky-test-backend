...
describe("User handler tests", () => {
    ...
    it("should create a favorite list", () => {
        ...
        const favList = userHandler.saveFavoriteHandler(
    ...
    it("should delete a media from user favorite list", () => {
        ...
        const userHandler = userHandlerWrapper(catalogList, userFavoritesList)
        const deleteMedia = userHandler.deleteMediaHandler(
            "user-123",
            "3fa85f64-5717-4562-b3fc-2c963f66afa5"
        )
    ...
    userHandler.saveFavoriteHandler("user-123", "3fa85f64-5717-4562-b3fc-2c963f66afa5");
    userHandler.saveFavoriteHandler("user-123", "3fa85f64-5717-4562-b3fc-2c963f66afa6");
    
    expect(userFavoritesList[0].favorites).toHaveLength(2);
    expect(userFavoritesList[0].favorites.map(m => m.id)).toEqual(["3fa85f64-5717-4562-b3fc-2c963f66afa5", "3fa85f64-5717-4562-b3fc-2c963f66afa6"]);
});
